        ...
        <div class="bg-white shadow-sm row row-cols-3 g-1">
            ...
            <div class="col-6 d-flex flex-column">
                ...
                <span class="product_description_welcome card-text small">
                    Espadrit Nike pump best choix footballers Espadrit Nike pump
                    best choix footballers Espadrit Nike pump best choix
                    footballers
                </span>

                <div class="price_new_old d-flex justify-content-start g-3">
            ...
            <div class="modal-content">
                ...
                >
                    <h6 class="modal-title" id="exampleModalLabel">
                        <i class="fas fa-cart-arrow-down"></i> Article ajouté à
                        votre panier
                    </h6>
                    <button
                        type="button"

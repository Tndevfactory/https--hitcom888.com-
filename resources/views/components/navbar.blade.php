...
<nav class="navbar navbar-expand-md navbar-light">
    <div class="container">
        ...
        >
            ...
            <span>
                <i
                    class=" {{App::isLocale('ar') ? 'brand_logo_ar' : 'brand_logo_fr'}} fas fa-shopping-cart position-absolute"
                ></i
            ></span>
        </a>
...
<nav class="navbar navbar-expand-md bg-light sticky-top">
    <div class="container d-flex gap-3 gap-md-0">
        ...
        >
            <ul
                class="navbar-nav mx-auto gap-0 px-3  {{App::isLocale('ar') ? 'navbar_placement_ar' : 'navbar_placement_fr'}}"
            >
                <li class="table_art_item nav-item">
                    <div class="hover_zone px-3">
                        <a

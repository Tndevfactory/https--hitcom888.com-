        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 g-3">
            ...
            <div class="col">
                <div class="card shadow-sm">
                    ...
                    <img src="https://picsum.photos/1300/902" class="d-block w-100" alt="..." />
                    <div class="card-body">
                        <small class="card-text">1235.345 TND.</small>
                        <small class="card-text">34%</small>
                        <small class="card-text">This content is a littlis a little bit longer</small>
...
{{-- @include('inc.slider_swipper') --}}
{{-- @include('inc.product_glyde') --}}
{{-- choose gsap

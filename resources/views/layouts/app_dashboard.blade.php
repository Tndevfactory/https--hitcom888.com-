    ...
    <body  dir="{{(App::isLocale('ar') ? 'rtl' : 'ltr')}}">
        ...
        <div class="px-1 px-md-0">
            <div class="row g-1 bg-light min-vh-100">
                ...
                <div class=" fixed_drawer col-2 bg-light d-none d-md-block px-3 pt-3 border border-right border-light shadow-sm">

                    <div class="header_dashboard d-flex justify-content-start  gap-3 mb-5">
                 ...
                 </div> {{-- end fixed drawer --}}
                



                <div class=" content_dashboard col-12 col-md-10  px-2 pt-3 bg-light">

                    <div class="header_dashboard d-flex justify-content-end  gap-3 mb-3">

                        <a class="open_mobile_drawer text-decoration-none text-dark d-block d-md-none" href="#">

                             <i class="menu_btn fas fa-bars mt-md-2 fa-2x"></i>
                        </a>


                        <div class="lang d-flex align-items-center me-1 ms-auto ">
                            <span>lANG</span> 
                         </div>
                        ...
                        <div class="deconnect">
                            <a href="#"> <i class="fas fa-sign-out-alt fa-2x me-3 "></i></a>
                        </div>

                        
                    </div>

                    <div class="border-top my-3 border-light shadow-sm position-relative"></div>
